package me.ajax.timewaterdrop.utils;
...
public class GeometryUtils {
     ...
     * 计算贝塞尔曲线路径
     */
    public static Path computeBezierPath(Path path, float ax, float ay, float bx, float by, float cx, float cy, float dx, float dy) {
